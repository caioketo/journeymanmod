...
{
    /*
     * KEF -  10/08/12:  Added this code block to put the
     * device into charge mode.  Without this and with the
     * original code commented out below, the device will be
     * powered but the battery will not charge.  Copied from
     * tuna_otg_pogo_charger().
     */
